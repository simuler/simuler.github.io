...
$$\frac{1}{\delta^2}=\frac{a_t}{\beta_t} + \frac{1}{1-\bar{a}_{t-1}},-2\mu=\frac{- (\frac{2\sqrt{a_t}}{\beta_t}x_t + \frac{2{\bar{a}_{t-1}}}{1-\bar{a}_{t-1}}x_0)}{\frac{a_t}{\beta_t} + \frac{1}{1-\bar{a}_{t-1}}} \\\\
\to  \delta^2 = \frac{1-\bar{a}_{t-1}}{1-\bar{a}_t}\beta_t, \mu = \frac{\sqrt{a}_t(1-\bar{a}_{t-1})}{1-\bar{a}_t}x_t + \frac{\sqrt{\bar{a}_{t-1}}\beta_t}{1-\bar{a}_t}x_0$$
